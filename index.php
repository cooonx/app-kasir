        ...
        <div class="card">
            ...
            <div class="form-group row mb-0">
                        ...
                        <div class="col-sm-8 mb-2">
                            ...
                            <input type="text" name="kode_barang" class="form-control form-control-sm border-right-0" list="datalist1" onchange="changeValue(this.value)"  aria-describedby="basic-addon2" placeholder="Masukkan Kode Barang" required>
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group-append">
                                <button style="background:#0080FF; color:white;" class="btn btn-sm" name="save" value="simpan" type="submit">
                                    <i class="fa fa-plus mr-2"></i>Tambah Barang</button>
                            </div>
                            </div>
                        </div>
                    </div> 
...
function format_ribuan ($nilai){
    return number_format ($nilai, 0, ',', '.');
            ...
            <form method="POST">
                ...
                <button style="background:#0080FF; color:white;" class="btn btn-sm" name="save1" value="simpan" type="submit">
                    <i class="fa fa-shopping-cart mr-2"></i>Bayar Sekarang</button> 
                </div>
            </form>
            <?php
  ...
  <div class="col-md-6 mb-3">
          ...
          <hr class="mt-0">
              ...
              <?php 
                ...
                while($d = mysqli_fetch_array($data_barang)){
                    ?>
              <div class="col-5 pr-0">
                  <a href="?id=<?php echo $d['id_cart']; ?>" onclick="javascript:return confirm('Yakin Ingin Hapus Data Barang ?');" style="text-decoration:none;">
              ...
              <div class="col-sm-12 mt-3 text-center">
                  <p>*TERIMA KASIH & SILAHKAN BERKUNJUNG KEMBALI*<br>
                  <font color="d80e05">Kelompok 6</font></p>
              </div>
              </div>
          </div>
      </div>
      <div class="text-right mt-3">
          <form method="POST">
            <button style="background:#0080FF; color:white;" class="btn btn-sm mr-2" onclick="printContent('print')"><i class="fa fa-print mr-1"></i> Print</button>

            <button style="background:#0080FF; color:white;" class="btn btn-sm" name="selesai" type="submit"><i class="fa fa-check mr-1"></i> Selesai</button>
          </form>
      </div>
      <?php
